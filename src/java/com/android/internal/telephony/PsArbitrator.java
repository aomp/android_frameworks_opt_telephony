...
public class PsArbitrator extends Handler implements Runnable{
    ...
    private static final int MMDC_PSD_SWITCH_CAUSE_NC0 = 2;
   ...
   //***** Constructor
    ...
    public void dispose() {
        ...
        //mLteDcManager.unregisterForAvailable(this, DctConstants.EVENT_RADIO_AVAILABLE, null);
        //mLteDcManager.unregisterForOffOrNotAvailable(this, EVENT_RADIO_NOT_AVAILABLE_LTE, null);        
    }
    ...
    private void syncRilDecisionMode(){
        mRil.getRilPsArbitrator().mDecisionMode = mDecisionPsMode;
        log("Sync to Ril: DecisionPsMode:" + mDecisionPsMode);
    }

    private void syncRilCurrentMode(){
        mRil.getRilPsArbitrator().mCurrentMode = mCurrentPsMode;
        log("Sync to Ril: CurrentPsMode:" + mCurrentPsMode);
    }
